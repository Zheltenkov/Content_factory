...
class PlanNode:
    """Accepted atomic competency normalized for curriculum planning."""
...
class SkillOccurrence:
    """Concrete appearance of a competency in a project."""
...
class PlanQualityMetrics:
    """Planner metrics for regression tests and methodologist review."""
